...
export { LAYER_REGISTRY, REFERENCE_LAYERS, OPTIONAL_LAYERS, PHASE_ORDER, getLayer, layersInDrawOrder, styleTokens, validateRegistry, phaseOf, regionOf, type ManifestLike } from "./layers/registry";
