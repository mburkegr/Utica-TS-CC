...
import { LAYER_REGISTRY, validateCollection, indexCollection, bboxWithin, OHIO_REGION_BBOX, unionBbox, hitTest, labelAnchor, pointInGeometry, placeLabels, type Bbox, type FeatureCollection } from "../gis/index";
...
check("registered: counties, townships, phase windows, type curve areas", Object.keys(EXPECTED).every((id) => LAYER_REGISTRY.some((l) => l.id === id)));
